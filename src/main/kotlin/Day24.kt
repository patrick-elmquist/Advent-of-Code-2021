...
//
//            val alu = Alu()
//            val input = "11111111111111".toList().map { it.digitToInt().toLong() }.log()
...
//            if (instruction is Inp) variables['i'] = inputs.removeFirst().also {
//                variables.log("var before input:$it :")
//            }
//
//            variables += instruction(variables)
//
//            if (instruction is Inp) variables.remove('i').also {
//                println()
//            }
//        }
//
...
//    operator fun invoke(memory: Map<Char, Long>): Map<Char, Long> = memory + execute(memory)
//
